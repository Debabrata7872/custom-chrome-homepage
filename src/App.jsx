          ...
          {authStep === 'onboarding' && (
            <div className="animate-in fade-in zoom-in-95 duration-300">
              ...
              <button
                ...
                className="w-full py-3.5 bg-white/5 hover:bg-white/10 border border-white/10 rounded-2xl text-sm font-medium tracking-wide transition-colors text-white mb-3 flex items-center justify-center gap-2"
              >
